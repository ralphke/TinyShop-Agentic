...
docker exec tinyshop-sqlserver /opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P 'P@ssw0rd123!' -C -Q "DROP DATABASE TinyShopDB;"
...
- Direct queries: `docker exec tinyshop-sqlserver /opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P 'password' -C -Q "your query"`
